                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Nhập vào mật khẩu" autocomplete="current-password">
