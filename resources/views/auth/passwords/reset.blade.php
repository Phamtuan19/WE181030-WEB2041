                                    ...
                                    <form action="{{ route('password.update') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text"
                                                ...
                                                id="exampleInputEmail" name="email" value="{{ $email ?? old('email') }}"
                                        ...
                                        <div class="form-group">
                                            <input type="password"
                                                ...
                                                id="exampleInputPassword" name="password"  placeholder="Nhập mật khẩu mới ..."
                                                style="padding: 1.5rem 1rem; border-radius: 1rem;" autocomplete="new-password">
                                        ...
                                        <div class="form-group">
                                            <input type="password"
                                                class="form-control form-control-user @error('password') is-invalid @enderror"
                                                id="exampleInputPassword" name="password_confirmation" placeholder="Nhập lại mật khẩu mới ..."
                                                style="padding: 1.5rem 1rem; border-radius: 1rem;" autocomplete="new-password">
